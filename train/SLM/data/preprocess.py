...
from data.tinytok import data_process, tokenize, train_new_tokenizer_bpe, create_val_sequences, create_train_sequences_gen, download_save_data
# or equivalently, run pip install tinytok and import the respective functions | see my package here: https://github.com/vxnuaj/tinytok

save_dir = 'train/SLM/data/data'
file_1 = 'train/SLM/data/data/train1.parquet'
file_2 = 'train/SLM/data/data/train2.parquet'
file_3 = 'train/SLM/data/data/train3.parquet'
file_4 = 'train/SLM/data/data/train4.parquet'
file_val = 'train/SLM/data/data/validation.parquet'
